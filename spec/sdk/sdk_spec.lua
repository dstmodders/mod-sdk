            ...
            describe("when both env and path are passed", function()
                ...
                describe("when path is resolved", function()
                    ...
                    it("should print info", function()
                        ...
                        SDK.Load(env, "yoursubdirectory/sdk")
                        assert.spy(SDK._Info).was_called(22)
                        ...
                        assert.spy(SDK._Info).was_called_with("Loaded", "SDK.Utils.Methods")
                        assert.spy(SDK._Info).was_called_with("Loaded", "SDK.Utils.String")
